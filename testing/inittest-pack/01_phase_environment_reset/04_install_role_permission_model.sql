...
/*
Phase 01 / Step 04
Install the current CBMSv21 role and permission model.
Source: backend-php/config/sql/sync_role_permission_model_v3.sql
*/
GO
...
(N'Base Configuration Administrator', N'SYSSETTINGS_VIEW'),
(N'Base Configuration Administrator', N'SYSSETTINGS_EDIT'),
(N'Base Configuration Administrator', N'SYSSETTINGS_ADMIN'),
...
(N'Strategy Configuration Administrator', N'STRATEGY_VIEW'),
(N'Strategy Configuration Administrator', N'STRATEGY_CONFIG_EDIT'),
(N'Strategy Configuration Administrator', N'STRATEGY_PUBLISH'),
(N'Strategy Configuration Administrator', N'STRATEGY_REPORT_VIEW'),
...
(N'Strategic Framework User', N'STRATEGY_REPORT_VIEW'),

(N'Strategic Framework Reviewer', N'STRATEGY_VIEW'),
(N'Strategic Framework Reviewer', N'STRATEGY_REPORT_VIEW'),
(N'Strategic Framework Reviewer', N'STRATEGY_SUBMISSION_REVIEW'),

(N'Strategic Framework Approver', N'STRATEGY_VIEW'),
(N'Strategic Framework Approver', N'STRATEGY_REPORT_VIEW'),
(N'Strategic Framework Approver', N'STRATEGY_SUBMISSION_REVIEW'),
(N'Strategic Framework Approver', N'STRATEGY_SUBMISSION_APPROVE'),
(N'Strategic Framework Approver', N'STRATEGY_PUBLISH'),

(N'Strategic Framework Reporting User', N'STRATEGY_VIEW'),
(N'Strategic Framework Reporting User', N'STRATEGY_REPORT_VIEW'),

(N'Strategic Framework Administrator', N'STRATEGY_VIEW'),
(N'Strategic Framework Administrator', N'STRATEGY_CONFIG_EDIT'),
(N'Strategic Framework Administrator', N'STRATEGY_REPORT_VIEW'),
(N'Strategic Framework Administrator', N'STRATEGY_PUBLISH'),
...
(N'Budget Submission Reviewer', N'STRATEGY_VIEW'),
(N'Budget Submission Reviewer', N'STRATEGY_REPORT_VIEW'),
(N'Budget Submission Reviewer', N'STRATEGY_SUBMISSION_REVIEW'),

(N'Budget Submission Approver', N'STRATEGY_VIEW'),
(N'Budget Submission Approver', N'STRATEGY_REPORT_VIEW'),
...
(N'Reporting Administrator', N'STRATEGY_VIEW'),
...
(N'Dashboard Administrator', N'ANALYTICS_VIEW');
...
SELECT DISTINCT
    ...
    rp.PermissionCode
FROM #RolePerm rp
LEFT JOIN #RolePerm existing
    ON existing.RoleName = N'System Administrator'
   AND existing.PermissionCode = rp.PermissionCode
WHERE rp.RoleName = N'Super Admin'
  AND existing.RoleName IS NULL;
