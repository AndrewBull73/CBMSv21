/*
Phase 01 / Step 06
Install the current CBMSv21 workflow foundation.
Sources:
- backend-php/config/sql/create_tblWorkflowAssignments.sql
...
;WITH SeedStage AS (
    ...
    UNION ALL SELECT N'SEGMENT_PUBLICATION', N'REVIEW', N'Review', 20, N'REVIEW', N'STRATEGY_CONFIG_EDIT,STRATEGY_SETUP_EDIT,STRATEGY_PUBLISH,ADMIN_ALL,SYSADMIN', 1, 1, 1, 0, 0, 0, 0
    UNION ALL SELECT N'SEGMENT_PUBLICATION', N'APPROVAL', N'Approval', 30, N'APPROVAL', N'STRATEGY_PUBLISH,ADMIN_ALL,SYSADMIN', 1, 1, 1, 0, 1, 0, 0
    UNION ALL SELECT N'SEGMENT_PUBLICATION', N'PUBLISH', N'Publish', 40, N'PUBLISH', N'STRATEGY_PUBLISH,ADMIN_ALL,SYSADMIN', 0, 0, 0, 0, 1, 0, 0
...
;WITH SeedAction AS (
    ...
    UNION ALL SELECT N'SEGMENT_PUBLICATION', N'FORWARD', N'Forward For Approval', N'REVIEW', N'APPROVAL', N'FORWARD', N'STRATEGY_CONFIG_EDIT,STRATEGY_SETUP_EDIT,STRATEGY_PUBLISH,ADMIN_ALL,SYSADMIN', 0
    UNION ALL SELECT N'SEGMENT_PUBLICATION', N'APPROVE', N'Approve', N'APPROVAL', N'PUBLISH', N'APPROVE', N'STRATEGY_PUBLISH,ADMIN_ALL,SYSADMIN', 0
    UNION ALL SELECT N'SEGMENT_PUBLICATION', N'PUBLISH', N'Publish', N'PUBLISH', N'PUBLISHED', N'PUBLISH', N'STRATEGY_PUBLISH,ADMIN_ALL,SYSADMIN', 0
    UNION ALL SELECT N'SEGMENT_PUBLICATION', N'RETURN', N'Return To Draft', N'REVIEW', N'DRAFT', N'RETURN', N'STRATEGY_CONFIG_EDIT,STRATEGY_SETUP_EDIT,STRATEGY_PUBLISH,ADMIN_ALL,SYSADMIN', 1
