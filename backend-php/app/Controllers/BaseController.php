...
abstract class BaseController
{
    ...
    protected function friendlyPermissionName(string $code): string
    {
        $labels = [
            ...
            'WORKFLOW_PROJECTS_VIEW' => 'Workflow Projects view access',
            'WORKFLOW_PROJECTS_CREATE' => 'Workflow Projects create access',
            'WORKFLOW_PROJECTS_EDIT' => 'Workflow Projects edit access',
            'WORKFLOW_PROJECTS_DELETE' => 'Workflow Projects delete access',
            'WORKFLOW_REQUIREMENTS_VIEW' => 'Workflow Requirements view access',
