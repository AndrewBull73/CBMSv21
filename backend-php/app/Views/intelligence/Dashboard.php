    ...
    <div class="card-body">
      ...
      <?php else: ?>
        ...
        <div class="row g-3">
          ...
          <div class="col-lg-4"><a class="d-block border rounded p-3 bg-white text-decoration-none" href="index.php?route=ai-dataset/index"><div class="fw-semibold">AI Dataset Analysis</div><div class="small text-muted">Run controlled analysis against approved datasets.</div></a></div>
        </div>
      <?php endif; ?>
    </div>
  </div>
