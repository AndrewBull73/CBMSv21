  ...
  <div class="card shadow-sm">
    ...
    <div class="card-body">
      ...
      <div class="row g-3 mb-4">
        <div class="col-6 col-xl-3"><div class="card shadow-sm h-100"><div class="card-body"><div class="text-muted small">Statuses</div><div class="fs-4 fw-semibold"><?= count($rows) ?></div></div></div></div>
      ...
      <div class="alert alert-info border-0 shadow-sm mb-4">
        Maintain the workflow task-status catalogue used by task transitions, notifications, and reporting. Keep codes deliberate because other workflow behavior depends on them.
      </div>
      ...
      <div class="card shadow-sm mb-4">
        ...
        <div class="card-body">
          <form method="get" action="index.php" class="row g-2">
            <input type="hidden" name="route" value="workflow-task-statuses/list">
            <div class="col-md-6">
            ...
            <div class="col-md-2 d-grid"><a class="btn btn-sm btn-outline-secondary" href="index.php?route=workflow-task-statuses/list">Reset</a></div>
          </form>
        </div>
      </div>
      ...
      <div class="card shadow-sm mb-4">
        <div class="card-header d-flex justify-content-between align-items-center gap-2 flex-wrap">
          <h5 class="mb-0">Status Register</h5>
          <a id="workflow-task-statuses-create-btn" href="index.php?route=workflow-task-statuses/form" class="btn btn-sm btn-primary"><i class="bi bi-plus-circle me-1"></i>Create Status</a>
        </div>
        <div class="card-body">
          <div class="table-responsive">
            <table class="table table-sm table-hover align-middle mb-0">
              ...
              <tbody>
                <?php if ($rows === []): ?>
                  <tr><td colspan="6" class="text-center text-muted py-3">No workflow task statuses found.</td></tr>
                <?php else: ?>
                  <?php foreach ($rows as $row): ?>
                    <tr>
                      <td class="fw-semibold"><?= (int) ($row['StatusID'] ?? 0) ?></td>
                      ...
                      <td class="text-end"><a class="btn btn-outline-primary btn-sm" href="index.php?route=workflow-task-statuses/form&id=<?= (int) ($row['StatusID'] ?? 0) ?>">Edit</a></td>
                    </tr>
                  <?php endforeach; ?>
                <?php endif; ?>
              </tbody>
