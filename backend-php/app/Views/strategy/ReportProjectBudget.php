...
foreach ($records as $row) {
    ...
    $programCount += (int) ($row['ProgramCount'] ?? 0);
}
  ...
  <div class="card shadow-sm">
    ...
    <div class="card-body">
      ...
      <div class="row g-3 mb-4">
        <div class="col-6 col-xl-3">
          <div class="card shadow-sm h-100">
            <div class="card-body">
              <div class="text-muted small">Project rows</div>
        ...
        <div class="col-6 col-xl-3">
          <div class="card shadow-sm h-100">
            <div class="card-body">
              <div class="text-muted small">Programs linked</div>
              <div class="fs-4 fw-semibold"><?= $programCount ?></div>
            </div>
          </div>
        </div>
        <div class="col-6 col-xl-3">
      ...
      <div class="alert alert-info border-0 shadow-sm mb-4">
        Use this report to review budget concentration by project and compare the breadth of program, output, and funding-source linkages before moving into detailed project usage analysis.
      </div>
      ...
      <div class="card shadow-sm mb-4">
        ...
        <div class="card-body">
          <form method="get" class="row g-2">
            <input type="hidden" name="route" value="strategy-reports/project-budget">
            <div class="col-md-6">
            ...
            <div class="col-md-6 d-flex gap-2">
              ...
              <a href="index.php?route=strategy-reports/project-budget" class="btn btn-sm btn-outline-secondary">Reset</a>
            </div>
          </form>
        </div>
      </div>
      ...
      <div class="card shadow-sm">
        <div class="card-header">
          <h5 class="mb-0">Project Budget Register</h5>
        </div>
        <div class="card-body">
          <div class="table-responsive">
            <table class="table table-sm table-hover align-middle mb-0">
              ...
              <tbody>
              <?php if ($records === []): ?>
                <tr><td colspan="7" class="text-center text-muted py-3">No project-linked budget rows yet for this context.</td></tr>
              <?php else: ?>
                  ...
                  <tr>
                    <td>
                      ...
                      <?php if (!empty($row['ProjectCode'])): ?>
                        <div class="small text-muted"><?= h((string) $row['ProjectCode']) ?></div>
                      <?php endif; ?>
                    </td>
