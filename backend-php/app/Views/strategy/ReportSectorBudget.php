  ...
  <div class="card shadow-sm">
    ...
    <div class="card-body">
      ...
      <div class="alert alert-info border-0 shadow-sm mb-4">
        Use this report to compare strategic budget scale by sector for the active context. Apply the project filter when you need a narrower read before drilling into programme or project reports.
      </div>
      ...
      <div class="card shadow-sm mb-4">
        ...
        <div class="card-body">
          <form method="get" class="row g-2">
            <input type="hidden" name="route" value="strategy-reports/sector-budget">
            <div class="col-md-6">
            ...
            <div class="col-md-6 d-flex gap-2">
              ...
              <a href="index.php?route=strategy-reports/sector-budget" class="btn btn-sm btn-outline-secondary">Reset</a>
            </div>
          </form>
        </div>
      </div>
      ...
      <div class="card shadow-sm mb-0">
        <div class="card-header">
          <h5 class="mb-0">Sector Budget Register</h5>
        </div>
        <div class="card-body">
      <div class="table-responsive">
        <table class="table table-sm table-hover align-middle mb-0">
          ...
          <tbody>
          <?php if ($records === []): ?>
            <tr><td colspan="7" class="text-center text-muted py-3">No sector budget rows yet for this context.</td></tr>
          <?php else: ?>
