...
$map = [
    ...
    'fiscal-years/form' => [
        ...
        'points' => [
            ...
            'Use the system-default option only for the primary baseline year the application should select by default.',
        ],
    ...
    'versions/list' => [
        'title' => 'Versions Help',
        'purpose' => 'Use this register to maintain submission and execution versions inside each fiscal year, including default-version behavior.',
        'points' => [
            'Create at least one active default submission version for each active fiscal year used in configuration.',
            'Use the fiscal year and version type filters to stay focused on the current setup baseline.',
        ...
        'note' => 'This screen controls fiscal-year version records and defaults. The system-wide default version is the one marked on the form as the system default context version.',
    ],
    'versions/form' => [
        'title' => 'Version Setup Help',
        'purpose' => 'Use this form to create or refine one version record within a fiscal year.',
        'points' => [
            'Choose the fiscal year and version type first so the version is created in the correct context.',
            'Mark only one active version as the default for a given fiscal year and version type.',
            'Use the system-default option only for the main version the application should select when no session context has been chosen yet.',
        ],
        'note' => 'Leave Version ID blank on create if you want the next available version number for that fiscal year.',
    ],
    'currencies/list' => [
