...
return [
    ...
    [
        ...
        'links' => [
            ...
            ['code' => 'ADWP', 'label' => 'Workflow Projects', 'route' => 'workflow-projects/list', 'perms' => ['WORKFLOW_OPERATIONS_VIEW', 'WORKFLOW_OPERATIONS_EDIT', 'WORKFLOW_OPERATIONS_ADMIN', 'ADMIN_ALL', 'SYSADMIN']],
            ['code' => 'ADWR', 'label' => 'Requirements', 'route' => 'workflow-requirements/list', 'perms' => ['WORKFLOW_OPERATIONS_VIEW', 'WORKFLOW_OPERATIONS_EDIT', 'WORKFLOW_OPERATIONS_ADMIN', 'ADMIN_ALL', 'SYSADMIN']],
            ['code' => 'ADRS', 'label' => 'Requirements Summary', 'route' => 'workflow-requirements/summary', 'perms' => ['WORKFLOW_OPERATIONS_VIEW', 'WORKFLOW_OPERATIONS_EDIT', 'WORKFLOW_OPERATIONS_ADMIN', 'ADMIN_ALL', 'SYSADMIN']],
            ['code' => 'ADRM', 'label' => 'Requirements Matrix', 'route' => 'workflow-requirements/matrix', 'perms' => ['WORKFLOW_OPERATIONS_VIEW', 'WORKFLOW_OPERATIONS_EDIT', 'WORKFLOW_OPERATIONS_ADMIN', 'ADMIN_ALL', 'SYSADMIN']],
    ...
    [
        ...
        'links' => [
            ...
            ['code' => 'ADTC', 'label' => 'Training', 'route' => 'training/scenarios', 'requiresTraining' => true],
            ['code' => 'ADTM', 'label' => 'Training Matrix', 'route' => 'training-admin/matrix', 'requiresTraining' => true, 'perms' => ['USERS_ADMIN', 'ADMIN_ALL', 'SYSADMIN']],
            ['code' => 'ADTO', 'label' => 'Training Operations', 'route' => 'training-admin/operations', 'requiresTraining' => true, 'perms' => ['USERS_ADMIN', 'ADMIN_ALL', 'SYSADMIN']],
            ['code' => 'ADTV', 'label' => 'Training Validation', 'route' => 'training-admin/validation', 'requiresTraining' => true, 'perms' => ['USERS_ADMIN', 'ADMIN_ALL', 'SYSADMIN']],
