...
return [
    ...
    [
        ...
        'links' => [
            ...
            ['code' => 'ADOS', 'label' => 'Load From Segments', 'route' => 'dataobjectcodes/syncOrgFromSegments'],
    ...
    [
        ...
        'links' => [
            ['code' => 'RCAT', 'label' => 'Report Catalogue', 'route' => 'reports/catalogue'],
            ['code' => 'RPSU', 'label' => 'Strategic Summary', 'route' => 'strategy-reports/summary'],
            ['code' => 'RPSB', 'label' => 'Sector Budget', 'route' => 'strategy-reports/sector-budget'],
            ['code' => 'RPPB', 'label' => 'Program Budget', 'route' => 'strategy-reports/program-budget'],
            ['code' => 'RPMT', 'label' => 'MTFF', 'route' => 'strategy-reports/mtff'],
            ['code' => 'DBOV', 'label' => 'Dashboard', 'route' => 'dashboard/index'],
            ['code' => 'ANOV', 'label' => 'Analytics', 'route' => 'analytics'],
        ],
    ],
    [
        'code' => 'BP',
    ...
    [
        ...
        'links' => [
            ...
            ['code' => 'ADWF', 'label' => 'Workflow Tasks', 'route' => 'workflow/list'],
