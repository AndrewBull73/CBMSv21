...
return [
  ...
  [
    ...
    'icon'  => 'diagram-3',
    'roles' => [],
    'perms' => ['BASE_CONFIG_VIEW','BASE_CONFIG_EDIT','DATAOBJECTCODES_ADMIN','STRATEGY_REPORT_VIEW','ADMIN_ALL','SYSADMIN'],
    ...
    'children' => [
      [
        ...
        'children' => [
          ...
          ['label'=>'Load Data Object Codes from Segment Values','code'=>'ADOS','route'=>'dataobjectcodes/syncOrgFromSegments','icon'=>'arrow-repeat','active'=>['dataobjectcodes/syncOrgFromSegments'],'roles'=>[],'perms'=>['DATAOBJECTCODES_ADMIN']],
      ...
      [
        ...
        'roles' => [],
        'perms' => ['BASE_CONFIG_VIEW','BASE_CONFIG_EDIT','STRATEGY_REPORT_VIEW','ADMIN_ALL','SYSADMIN'],
        'children' => [
  ...
  [
    ...
    'roles' => [],
    'perms' => ['AUTHENTICATED','STRATEGY_REPORT_VIEW','ANALYTICS_VIEW','ADMIN_ALL','SYSADMIN'],
  ...
  [
    ...
    'roles' => [],
    'perms' => ['BASE_CONFIG_VIEW','BASE_CONFIG_EDIT','STRATEGY_CONFIG_EDIT','STRATEGY_REPORT_VIEW','FIN_CONFIG_VIEW','FIN_CONFIG_EDIT','CALC_ADMIN','AUDIT_VIEW','HEALTH_VIEW','METRICS_VIEW','SYSADMIN','ADMIN_ALL'],
    'active' => ['base-config/*','financial-config/*','strategy-config/configuration-readiness','strategy-config/resolution-check','strategy-reports/submission-readiness','strategy-reports/program-structure','transaction-calc-diagnostics/*','full-recalculation/*','diagnostics/*','health/*','application-log/*'],
    'children' => [
      [
      ...
      [
        ...
        'icon'  => 'activity',
        'roles' => [],
        'perms' => ['STRATEGY_REPORT_VIEW','STRATEGY_CONFIG_EDIT','CALC_ADMIN','AUDIT_VIEW','HEALTH_VIEW','SYSADMIN','ADMIN_ALL'],
        'children' => [
  ...
  [
    ...
    'icon'  => 'sliders',
    'roles' => [],
    'perms' => ['BASE_CONFIG_VIEW','BASE_CONFIG_EDIT','FIN_CONFIG_VIEW','FIN_CONFIG_EDIT','CALC_ADMIN','STRATEGY_CONFIG_EDIT','STRATEGY_PUBLISH','SYSSETTINGS_VIEW','SYSSETTINGS_EDIT','WORKFLOW_VIEW','WORKFLOW_EDIT','WORKFLOW_ADMIN','USERS_ADMIN','ADMIN_ALL','SYSADMIN'],
    'active' => ['fiscal-years/*','versions/*','version-types/*','currencies/*','currency-rates/*','system-settings/*','workflow-engine/*','workflow-task-types/*','workflow-task-statuses/*','workflow-assignments/*','transaction-type-segment-config/*','scenario-admin/*','report-admin/*','integration-admin/*','training-admin/*','screen-tests-admin/*'],
    'children' => [
      [
      ...
      [
        'label' => 'Training & Testing Configuration',
        'code'  => 'CFTT',
        'icon'  => 'mortarboard',
        'roles' => [],
        ...
        'children' => [
          ...
          ['label'=>'Test Script Catalogue','code'=>'CFTS','route'=>'screen-tests-admin/scenarios','icon'=>'journal-text','active'=>['screen-tests-admin/*'],'roles'=>[],'perms'=>['USERS_ADMIN','ADMIN_ALL','SYSADMIN'],'enabled'=>$testingEnabled],
        ],
      ],
    ],
  ],
  ...
  [
    ...
    'icon'  => 'gear',
    'roles' => [],
    'perms' => ['USERS_VIEW','ROLES_VIEW','AUDIT_VIEW','HEALTH_VIEW','SESSION_VIEW','METRICS_VIEW','WORKFLOW_VIEW','WORKFLOW_EDIT','WORKFLOW_ADMIN','SYSADMIN','ADMIN_ALL'],
    'children' => [
      [
      ...
      [
        ...
        'icon'  => 'list-task',
        'roles' => [],
        'perms' => ['WORKFLOW_VIEW','WORKFLOW_EDIT','WORKFLOW_ADMIN','ADMIN_ALL','SYSADMIN'],
        'children' => [
      ...
      [
        ...
        'icon'  => 'activity',
        'roles' => [],
        'perms' => ['AUDIT_VIEW','METRICS_VIEW','HEALTH_VIEW','SYSADMIN','ADMIN_ALL'],
        'children' => [
