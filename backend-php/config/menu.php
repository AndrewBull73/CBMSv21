...
return [
  ...
  [
    ...
    'icon'  => 'list-task',
    'roles' => [],
    'perms' => ['WORKFLOW_OPERATIONS_VIEW','WORKFLOW_OPERATIONS_EDIT','WORKFLOW_OPERATIONS_ADMIN','USERS_VIEW','USERS_ADMIN','ADMIN_ALL','SYSADMIN'],
    ...
    'children' => [
      ...
      ['label'=>__t('workflow_projects'),'code'=>'ADWP','route'=>'workflow-projects/list','icon'=>'kanban','active'=>['workflow-projects/*'],'roles'=>[],'perms'=>['WORKFLOW_OPERATIONS_VIEW','WORKFLOW_OPERATIONS_EDIT','WORKFLOW_OPERATIONS_ADMIN','ADMIN_ALL','SYSADMIN']],
      ['label'=>__t('workflow_requirements'),'code'=>'ADWR','route'=>'workflow-requirements/list','icon'=>'journal-richtext','active'=>['workflow-requirements/*'],'roles'=>[],'perms'=>['WORKFLOW_OPERATIONS_VIEW','WORKFLOW_OPERATIONS_EDIT','WORKFLOW_OPERATIONS_ADMIN','ADMIN_ALL','SYSADMIN']],
      ['label'=>__t('workflow_requirement_summary'),'code'=>'ADRS','route'=>'workflow-requirements/summary','icon'=>'speedometer2','active'=>['workflow-requirements/summary'],'roles'=>[],'perms'=>['WORKFLOW_OPERATIONS_VIEW','WORKFLOW_OPERATIONS_EDIT','WORKFLOW_OPERATIONS_ADMIN','ADMIN_ALL','SYSADMIN']],
      ['label'=>__t('workflow_requirement_matrix'),'code'=>'ADRM','route'=>'workflow-requirements/matrix','icon'=>'diagram-3','active'=>['workflow-requirements/matrix'],'roles'=>[],'perms'=>['WORKFLOW_OPERATIONS_VIEW','WORKFLOW_OPERATIONS_EDIT','WORKFLOW_OPERATIONS_ADMIN','ADMIN_ALL','SYSADMIN']],
